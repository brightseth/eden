...
exports.citizenDune = exports.CitizenDuneIntegration = void 0;
class CitizenDuneIntegration {
    constructor() {
     ...
     */
    async executeDuneQuery(queryId, parameters = {}) {
        if (!this.duneApiKey) {
     ...
     */
    calculateOverallStats(collections, volumeTrends = []) {
        const baseStats = {
     ...
     */
    async getCollectionAnalytics(contractAddress) {
        if (!this.duneApiKey)
            return null;
...
exports.CitizenDuneIntegration = CitizenDuneIntegration;
exports.citizenDune = new CitizenDuneIntegration();
