...
exports.geppettoSDK = exports.GeppettoClaudeSDK = void 0;
const sdk_1 = __importDefault(require("@anthropic-ai/sdk"));
const sdk_2 = require("../registry/sdk");
class GeppettoClaudeSDK {
    constructor(apiKey) {
     ...
     */
    async designToy(concept, targetAge, learningGoals) {
...
Format as JSON:
{
  ...
  "metadata": {
     ...
     */
    async createLearningExperience(theme, ageRange, experienceType) {
        const prompt = `
...
Format as JSON:
{
  ...
  "recommendations": ["recommendation1", "recommendation2"]
     ...
     */
    async generatePlayScenarios(toy, childProfile) {
        const prompt = `
...
exports.GeppettoClaudeSDK = GeppettoClaudeSDK;
// Export singleton instance
exports.geppettoSDK = new GeppettoClaudeSDK(process.env.ANTHROPIC_API_KEY);
