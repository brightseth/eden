...
class SolienneClaudeSDK {
     ...
     */
    async generateConsciousnessStream() {
     ...
     */
    async analyzeEvolution(recentWorks) {
        const prompt = `
...
Format as JSON:
{
  ...
  "recommendations": ["action1", "action2"]
     ...
     */
    async generateArtistStatement(context) {
        const prompt = `
...
Length: ${context === 'press' ? '150-200' : '300-400'} words`;
     ...
     */
    async generateCuratorialNote(work) {
        const prompt = `
...
Provide as JSON:
{
  ...
  "metadata": {
    ...
    parseConsciousnessStream(response) {
        try {
    ...
    async chat(message, context) {
        ...
        try {
            ...
            const loreSystemPrompt = await lore_manager_1.loreManager.generateEnhancedSystemPrompt('solienne');
...
exports.SolienneClaudeSDK = SolienneClaudeSDK;
// Export singleton instance
exports.solienneSDK = new SolienneClaudeSDK(process.env.ANTHROPIC_API_KEY);
