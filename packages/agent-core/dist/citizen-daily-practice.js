...
exports.citizenDailyPractice = exports.CitizenDailyPracticeCoordinator = void 0;
const citizen_claude_sdk_1 = require("./citizen-claude-sdk");
const farcaster_connector_1 = require("./social-platforms/farcaster-connector");
const discord_connector_1 = require("./social-platforms/discord-connector");
const twitter_connector_1 = require("./social-platforms/twitter-connector");
class CitizenDailyPracticeCoordinator {
    constructor() {
        this.connectors = {};
...
Next: Regular community governance rhythms. What cadence feels right to you?`,
    ...
    async analyzeCommunityReadiness() {
        ...
        for (const platform of platforms) {
            try {
                ...
                if (!connector)
                    continue;
                let analysis;
                if (platform === 'farcaster' && connector instanceof farcaster_connector_1.FarcasterConnector) {
                    analysis = await connector.analyzeCommunityActivity('brightmoments');
                }
                else if (platform === 'discord' && connector instanceof discord_connector_1.DiscordConnector) {
                    analysis = await connector.analyzeCommunityActivity();
                }
                else if (platform === 'twitter' && connector instanceof twitter_connector_1.TwitterConnector) {
    ...
    async adaptContentForPlatforms(content) {
        const adaptations = {};
        for (const platform of content.platforms) {
            const prompt = `
...
`;
            try {
                const response = await citizen_claude_sdk_1.citizenSDK.chat([{
                        role: 'user',
                        content: prompt
                    }]);
    ...
    // Platform Management
    connectPlatform(platform, connector) {
...
exports.CitizenDailyPracticeCoordinator = CitizenDailyPracticeCoordinator;
// Export singleton
exports.citizenDailyPractice = new CitizenDailyPracticeCoordinator();
