...
exports.miyomiSDK = exports.MiyomiClaudeSDK = void 0;
const sdk_1 = __importDefault(require("@anthropic-ai/sdk"));
const market_connectors_1 = require("./market-connectors");
class MiyomiClaudeSDK {
    constructor(apiKey) {
     ...
     */
    async generatePicks(maxPicks = 3) {
     ...
     */
    async analyzeMarket(marketDescription, currentOdds) {
        const prompt = `
...
`;
     ...
     */
    async generateVideoScript(pick) {
        const prompt = `
...
`;
    ...
    async fetchRelevantMarkets() {
        try {
            console.log('Fetching market data from all platforms...');
            const markets = await market_connectors_1.marketAggregator.getAllMarkets(50);
    ...
    async findContrarianOpportunities(markets) {
...
`;
    ...
    parsePicks(response) {
        try {
            ...
            // Validate each pick
            return picks.filter((pick) => this.validatePick(pick));
        }
        catch (error) {
...
exports.MiyomiClaudeSDK = MiyomiClaudeSDK;
// Export singleton instance
exports.miyomiSDK = new MiyomiClaudeSDK(process.env.ANTHROPIC_API_KEY);
