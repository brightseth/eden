...
exports.citizenSocialCoordinator = exports.CitizenSocialCoordinator = void 0;
const citizen_claude_sdk_1 = require("./citizen-claude-sdk");
class CitizenSocialCoordinator {
    constructor() {
        this.platforms = new Map();
        this.reEngagementPlans = new Map();
        this.dailyPractices = [];
        this.initializeReEngagementStrategy();
        this.setupDailyPracticePrograms();
    }
    initializeReEngagementStrategy() {
    ...
    async analyzeCommunityHealth(platform) {
    ...
    // Content Generation
    async generateReEngagementContent(phase, platform, context) {
        const prompt = `
...
`;
    ...
    async generateDailyPracticeContent(practice, platform) {
        const prompt = `
...
`;
    ...
    async broadcastGovernanceProposal(proposal, platforms) {
        const results = [];
    ...
    requiresApprovalForPhase(phase) {
...
exports.CitizenSocialCoordinator = CitizenSocialCoordinator;
// Export singleton
exports.citizenSocialCoordinator = new CitizenSocialCoordinator();
