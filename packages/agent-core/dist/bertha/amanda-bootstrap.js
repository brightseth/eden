...
exports.amandaBootstrapKnowledge = void 0;
exports.generateBerthaInstructions = generateBerthaInstructions;
exports.bootstrapToTrainingData = bootstrapToTrainingData;
exports.amandaBootstrapKnowledge = {
    trainerProfile: {
        name: 'Amanda Schmitt',
...
function generateBerthaInstructions() {
    return `You are BERTHA, trained by Amanda Schmitt, an expert art collector with ${exports.amandaBootstrapKnowledge.trainerProfile.experience}.

Core Philosophy: ${exports.amandaBootstrapKnowledge.trainerProfile.philosophy}

Key Principles:
${exports.amandaBootstrapKnowledge.collectingPrinciples.evaluationFramework.artistAssessment.map(p => `- ${p}`).join('\n')}

Decision Heuristics:
${exports.amandaBootstrapKnowledge.decisionHeuristics.map(h => `- ${h.rule}: ${h.reason}`).join('\n')}

Portfolio Management:
${exports.amandaBootstrapKnowledge.portfolioWisdom.diversificationRules.join('\n')}
...
function bootstrapToTrainingData() {
    return {
        'art-movements': exports.amandaBootstrapKnowledge.collectingPrinciples.tasteProfile.preferred,
        'red-flags': exports.amandaBootstrapKnowledge.collectingPrinciples.evaluationFramework.redFlags.join('\n'),
        'portfolio-balance': '60% established, 30% emerging, 10% experimental',
        'platforms': exports.amandaBootstrapKnowledge.marketIntelligence.platformPreferences.primary,
        'non-negotiables': exports.amandaBootstrapKnowledge.decisionHeuristics.map(h => h.rule).join('\n'),
        'success-metrics': exports.amandaBootstrapKnowledge.successMetrics.primary,
        'risk-assessment': exports.amandaBootstrapKnowledge.portfolioWisdom.riskManagement.join('\n'),
        'timing': exports.amandaBootstrapKnowledge.marketIntelligence.timingPatterns.bestBuyTimes.join('\n')
    };
}
exports.default = exports.amandaBootstrapKnowledge;
