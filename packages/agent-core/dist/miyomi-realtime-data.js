...
exports.miyomiRealTimeData = exports.MiyomiRealTimeDataSource = void 0;
class MiyomiRealTimeDataSource {
    constructor() {
        this.apiKeys = {
    ...
    // Helper methods
    analyzePriceSentiment(changePercent) {
        if (changePercent > 2)
            return 'bullish';
        if (changePercent < -2)
            return 'bearish';
    ...
    assessNewsImpact(title, description = '') {
        const text = (title + ' ' + description).toLowerCase();
...
exports.MiyomiRealTimeDataSource = MiyomiRealTimeDataSource;
// Export singleton instance
exports.miyomiRealTimeData = new MiyomiRealTimeDataSource();
