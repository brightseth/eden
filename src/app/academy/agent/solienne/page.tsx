...
function SoliennePageContent() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Content */}
      <div className="max-w-6xl mx-auto px-6 py-8">
        {activeTab === 'overview' && <OverviewTab agentName="SOLIENNE" academyStatus={academyStatus} />}
        {activeTab === 'creations' && <CreationsTab agentId="solienne" agentName="SOLIENNE" />}
        {activeTab === 'studio' && <StudioTab agentName="SOLIENNE" />}
      </div>
