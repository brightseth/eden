...
export default function CitizenDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      // Mock data for demo since APIs might not be fully connected
        ...
        trainers: [
          {
            ...
            level: 'primary',
            permissions: ['train', 'review', 'approve', 'sync'],
            status: 'active',
            trainingCount: 23,
          ...
          },
          {
            ...
            role: 'System Admin',
            level: 'admin',
            permissions: ['train', 'review', 'approve', 'sync', 'admin'],
            status: 'active',
            trainingCount: 42,
            joinedAt: '2025-08-27T21:00:00Z'
          }
        ],
        sessions: { total: 7, active: 2, completed: 5 },
        training_sessions: [
          {
            id: 'session-1756440123-abc123',
            agent: 'CITIZEN',
            created_by: 'henry',
            collaborators: ['keith'],
            status: 'active',
            created_at: '2025-08-29T02:30:00Z',
            last_activity: '2025-08-29T03:45:00Z',
            training_submissions: [],
            sync_status: {
              registry_synced: true,
              app_eden_synced: true,
              last_sync: '2025-08-29T03:45:00Z'
            }
          }
        ],
        pending_review: {
        ...
        training_items: [
          {
            id: 'training-1',
            trainer: 'henry',
            content: 'Update CITIZEN with new BM governance procedures for Q1 2026...',
            training_type: 'governance_update',
            status: 'pending',
            review_context: {
              approval_count: 1,
              rejection_count: 0,
      ...
      setData({
        ...
        training_sessions: [],
        pending_review: { total_items: 0, high_priority: 0, consensus_needed: 0, ready_to_apply: 0 },
        training_items: []
      });
    } finally {
      setLoading(false);
