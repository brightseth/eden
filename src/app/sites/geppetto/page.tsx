      ...
      <div className="border-b border-white">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <Link 
            ...
            className="flex items-center gap-2 text-sm hover:bg-white hover:text-black px-2 py-1 transition-all uppercase tracking-wider"
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all ${
              privateMode 
                ? 'bg-black border-2 border-white hover:bg-white hover:text-black' 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="px-3 py-1 text-xs bg-black text-white border border-white uppercase tracking-wider">
                  LATTICE TRAINED
                </span>
              </div>
              
              <h1 className="text-6xl font-bold mb-6 text-white uppercase tracking-wider">
                GEPPETTO STUDIO
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="px-4 py-2 bg-black border border-white">
                  <span className="text-white font-mono uppercase tracking-wider">TRAINERS: MARTIN & COLIN</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="aspect-square bg-black border border-white overflow-hidden">
                <div className="absolute inset-4 border border-dashed border-gray-600 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-32 h-32 mx-auto mb-4 bg-black border border-white flex items-center justify-center">
                    ...
                    <button 
                      ...
                      className="mt-2 px-3 py-1 text-xs bg-black border border-white hover:bg-white hover:text-black transition-all uppercase tracking-wider">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`w-2 h-2 rounded-full ${
                    index === activeProcess ? 'bg-white animate-pulse' : 'bg-white/30'
                  }`} />
                </div>
      ...
      <div className="border-t border-white bg-black">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex justify-between items-center mb-12">
            ...
            {privateMode && (
              <span className="text-sm text-white bg-black border border-white px-3 py-1 uppercase tracking-wider">
                CONFIDENTIAL
              </span>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {productConcepts.map((concept) => (
              <div key={concept.id} className="group">
                <div className="bg-black overflow-hidden border border-white hover:border-white/80 transition-all">
                  {/* Product Image Placeholder */}
                  <div className="aspect-video bg-black border border-white flex items-center justify-center">
                    <div className="text-center">
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        concept.status === 'production' ? 'bg-white text-black' :
                        concept.status === 'testing' ? 'bg-black text-white border border-white' :
                        concept.status === 'prototype' ? 'bg-amber-500/20 text-amber-400' :
                        'bg-black/50 text-white/50 border border-white/50'
                      }`}>
