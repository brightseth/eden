...
class UnifiedAgentService {
  ...
  private extractSocialProfiles(agent: Agent): { twitter?: string; farcaster?: string; website?: string } {
    ...
    const socialMap: Record<string, any> = {
      ...
      'bertha-006': { twitter: '@bertha_taste', website: 'https://eden-academy-flame.vercel.app/academy/agent/amanda' },
      'bertha': { twitter: '@bertha_taste', website: 'https://eden-academy-flame.vercel.app/academy/agent/amanda' },
