...
export default function MiyomiDashboard() {
  const [activeTab, setActiveTab] = useState<'overview' | 'trading' | 'signals' | 'concepts' | 'videos' | 'generation' | 'testing' | 'training' | 'performance' | 'revenue'>('overview');
      ...
      <div className="border-b border-white/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-8">
            {['overview', 'trading', 'signals', 'concepts', 'videos', 'generation', 'testing', 'training', 'performance', 'revenue'].map(tab => (
              <button
                key={tab}
