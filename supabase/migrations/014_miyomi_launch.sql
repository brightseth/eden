...
CREATE INDEX idx_miyomi_picks_timestamp ON miyomi_picks(timestamp DESC);
CREATE INDEX idx_miyomi_picks_status ON miyomi_picks(status);
CREATE INDEX idx_miyomi_picks_platform ON miyomi_picks(platform);
CREATE INDEX idx_miyomi_picks_category ON miyomi_picks(category);
CREATE INDEX idx_miyomi_performance_date ON miyomi_performance(date DESC);
...
INSERT INTO miyomi_config (active) VALUES (true) ON CONFLICT DO NOTHING;
